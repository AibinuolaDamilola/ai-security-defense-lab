...
def render_level4(user, supabase_client):
    ...
    st.markdown(
        ...
        '<div style="color:#fff;font-size:15px;margin-bottom:10px;"><strong>Guiding Question:</strong> When a RAG system and its fine-tuning pipeline both trust something they shouldn\'t, where does the boundary actually need to live?</div>' +
